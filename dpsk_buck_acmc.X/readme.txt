DPSK3 Closed Loop Adaptive Gain Control 
=======================================

This code example establishes a closed loop control system using voltage mode control
of the buck converter of the Digital Power Starter Kit 3 (Part-No. DM330017-3). The
gain of this voltage mode control loop is continuously modulated during runtime to account
for gain changes in the power plant caused by differences in th voltage drop across the 
inductor. As a result, the voltage mode control loop remains a stable bandwidth and stability
margin across the entire operating range.
...
The control system consists of two major blocks:
	...
	- In-Loop Adaptive Gain Modulation
...
Hardware:
    ...
    TP1  = Input Voltage
    TP12 = Buck Converter Output Voltage

    TP11 = Buck Converter Switch Node
    TP31 = Buck Converter PWM High Side
    TP30 = Buck Converter PWM Low Side
...
User Input:
    ...
    BUCK_LOAD = Switches between 0%, 25%, 50% and 100% load @ nominal VOUT of 3.3V
...
banks of buck and boost converter.
             ------------------
            | VIN     = 9.00 V |
            | TEMP    = 25.0 C |
             ------------------
...
define is set to TRUE, the common main control loop is replaced by the proportional controller.
    ...
    config\hal\dpsk3_hwdescr.h, line 69:   #define PLANT_MEASUREMENT   false
